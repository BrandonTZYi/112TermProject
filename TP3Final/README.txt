...
The code is all in one file, so just run the "TP3FinalCode" file, and play the game.
...
If you Hit "r", it will randomly generate a new map, randomly generate new enemy positions, and reset you back to dungeon level 1.